package com.example.uwb_gg_api.authentication;

import com.example.uwb_gg_api.activationTracker.ActivationTracker;
import com.example.uwb_gg_api.authentication.models.AuthenticateRequest;
import com.example.uwb_gg_api.authentication.models.AuthenticationDto;
...
public class AuthenticationController {
    ...
    public ResponseEntity<String> test(HttpRequest request) {
        return new ResponseEntity<>("You've hit " + request.getURI().getHost(), HttpStatus.OK);
    }
